...
import { REGISTER_INDICATION } from '../../../core/utils/constans';
...
export const RegisterIndication = () => {
    ...
    const handleSubmit = (values: Indication, resetForm: any) => {
        setIsSubmitting(true);
        axiosInstance
            .post(`${REGISTER_INDICATION}`, values)
            .then(response => {
                setToastMessage('Indicação criada com sucesso!');
